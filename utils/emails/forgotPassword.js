...
<img class=" " width="160" height="250" src="https://res.cloudinary.com/loud-behaviour/image/upload/q_auto,f_auto/v1585928309/Logo_1_oadhai_gmgme7.png" style="height: auto; line-height: 100%; outline: none; text-decoration: none; border: 0 none;"><table class="s-3 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
  <tbody>
    <tr>
  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="left">
        <div>
            <div class="HeaderContainer" style="background-color: rgb(28, 41, 71); color: #ffffff; font-size: 15px; padding: 20px;">
                <h1 class="text-center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; color: inherit; vertical-align: baseline; font-size: 36px; line-height: 43.2px;" align="center">Reset Password</h1>
            </div>
  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
        <div>
                <div class="intro-con" style="margin-top: 10px; padding: 8px;">
                    <p class="intro-text" style="line-height: 24px; font-size: 16px; margin: 0;" align="left">Hi ${details.name},</p>
<p style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                    </p>
<p class="intro-text" style="line-height: 24px; font-size: 16px; margin: 0;" align="left">You have requested to reset your password on Loud Behaviour.</p>
<p style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                    </p>
<p class="intro-text" style="line-height: 24px; font-size: 16px; margin: 0;" align="left">Yes, we've got you covered, please click the button below to proceed.</p>
<p style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                </p>
</div>
...
<div class=" text-center" style="" align="center">
                <table class="btn btn-secondary btn-lg btn-over" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: separate !important; border-radius: 4px;" bgcolor="1C2947">
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-radius: 4px; margin: 0;" align="center" bgcolor="#868e96">
        <a target="_blank" href=${details.link} style="font-size: 20px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 4.8px; line-height: 30px; display: inline-block; font-weight: normal; white-space: nowrap; background-color: #868e96; color: #ffffff; padding: 8px 16px; border: 1px solid #868e96;">RESET PASSWORD</a>
      </td>
    </tr>
  </tbody>
</table>
...
<div class=" ">
                <p class="text-muted" style="line-height: 24px; font-size: 16px; color: #636c72; margin: 0;" align="left">If you have not requested to change your password then you can ignore this message and be rest assured that your account is secure</p>
              </div>
<table class="s-5 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
  <tbody>
    <tr>
...
<table class="s-4 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
  <tbody>
    ...
    <div class="text-center footer" style="color: #ffffff; background-color: rgb(217, 111, 69);" align="center">
        <p class="text-center footer-text" style="line-height: 24px; font-size: 16px; margin: 0; padding: 25px;" align="center">Thanks for using <a href="loudbehaviour.com" target="_blank" style="color: #ffffff;">loudbehaviour.com</a></p>
    </div>
