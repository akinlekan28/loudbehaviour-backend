module.exports = (details) => {
        ...
        <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="left">
          <div>
              <div class="HeaderContainer" style="background-color: rgb(28, 41, 71); color: #ffffff; font-size: 15px; padding: 20px;">
                  <h1 class="text-center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; color: inherit; vertical-align: baseline; font-size: 36px; line-height: 43.2px;" align="center">Contact Form Details</h1>
              </div>
  ...
  <p class="intro-text" style="line-height: 24px; font-size: 16px; margin: 0;" align="left">You have a new message enquiry from Loud Behaviour.</p>
  <p style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                      </p>
                      <br />
                      <p class="intro-text" style="line-height: 24px; font-size: 16px; margin: 0;" align="left">${"\n\n\n"}</p>

  <p class="intro-text" style="line-height: 24px; font-size: 16px; margin: 0;" align="left">Name: ${
    details.firstName + " " + details.lastName
  }</p>
  <p class="intro-text" style="line-height: 24px; font-size: 16px; margin: 0;" align="left">Phone: ${
    details.phone
  }</p>
  <p class="intro-text" style="line-height: 24px; font-size: 16px; margin: 0;" align="left">Reason: ${
    details.reason
  }</p>
  <p class="intro-text" style="line-height: 24px; font-size: 16px; margin: 0;" align="left">Message: ${
    details.message
  }</p>
